                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{optional($_e)->paid}}" name="paid" type="text" id="p-amount" number="number" class="pa form-control kb-pad p-amount">
                                </div>
                            </div>
...
@push('crud_fields_scripts')
    <script>
        ...
        function calculate_payment(amt_paid = 0){
            var grand_total = round($('.h_gtotal').val() - 0,6);
            var paid        = amt_paid?amt_paid:calQuickAmt();
            var balance     = round(grand_total - paid, 6);
