                    ...
                    <tbody>
                        @if($g_pending != null)
                            ...
                            @foreach($g_pending as $r)
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" id="c-checked-group{{$i}}" data-payment="{{$total}}" class="form-check-input c-checked-group" name="approve_check[{{$rand_id}}]" onclick="ckChange(this)" value="{{$r->group_id}}"/></td>
                                    ...
                                    <td>
                                        <a href="{{url("admin/list-due-member-repayment?group_loan_id={$r->group_id}&rand_id={$rand_id}")}}"
...
@section('after_scripts')
    ...
    <script>
        ...
        function ckChange(ckType){
            var ckName = document.getElementsByClassName('c-checked-group');
    ...
    <script>
        function repay_filter() {
            ...
            window.location.href = "{{url('admin/group-due-repayment')}}?group_id="+group_id+"&center_id="+center_id+"&loan_product_id="+loan_product_id;
