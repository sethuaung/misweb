    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
                ...
                var g_total=crud.table.column(8).data().sum()-0;
                var paid=crud.table.column(6).data().sum()-0;
                var balance=crud.table.column(7).data().sum()-0;
                $("#qty").html(qty.format(0));
                @if(companyReportPart() == 'company.theng_hok_ing')
                    $("#g-total").html(g_total.format(0));
                    $("#paid").html(paid.format(0));
                    $("#balance").html(balance.format(0));
                @elseif(companyReportPart()=='company.myanmarelottery_account')
                    $("#g-total").html(g_total.format(-2));
                    $("#paid").html(paid.format(-2));
                    $("#balance").html(balance.format(-2));
                @else
                    $("#g-total").html(g_total.format(0));
                    $("#paid").html(paid.format(0));
                    $("#balance").html(balance.format(0));
        ...
        @if(companyReportPart()=='company.logistic')
            $('tfoot').hide();
        @endif
