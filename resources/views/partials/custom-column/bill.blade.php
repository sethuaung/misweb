    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
                ...
                var qty=crud.table.column(4).data().sum()-0;
                var g_total=crud.table.column(7).data().sum()-0;
                var paid=crud.table.column(5).data().sum()-0;
                var balance=crud.table.column(6).data().sum()-0;
