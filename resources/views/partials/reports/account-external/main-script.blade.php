...
<div class="show-report"  style=" width: 100%; background-color: #ffffff; padding: 20px; -webkit-box-shadow: 0px 6px 26px -6px rgba(0,0,0,0.48);
    ...
    <script>
        ...
        $(function () {
            ...
            $('body').on('click','.report-url',function (e) {
                ...
                var date_only=$(this).data('date-only')!=null?$(this).data('date-only'):0;
                ...
                if (date_only==1) {
                    $( "#id_start_date" ).datepicker('getDate');
                    $( "#id_start_date" ).datepicker('setDate', null);
                    $( "#id_start_date" ).datepicker('setDate','');

                    $('[name="start_date"]').parent().css('display', 'none');

                    // $('#select2_multiple_class_id').parent().css('display', 'none');
                    // $('#select2_multiple_class_id').val('').trigger('change');
                    $('.label_end_date').html("Date")

                } else {
                    $('[name="start_date"]').parent().show();
                    $('.label_end_date').html("End Date")

                    // $('#select2_ajax_multiple_user_id').parent().show();
                    // $('#select2_ajax_multiple_user_id').val('').trigger('change');
