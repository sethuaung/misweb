<div id="DivIdToPrintPop">
    ...
    <h2 style="padding: 0px; font-weight: bold;text-align: center">Open Item</h2></h1>
        ...
        <tr>
            <td style="padding-right: 15px;">
                <div style="border: 1px solid #000; border-radius: 5px; padding: 10px">
                    ...
                    <p>កាលបរិច្ឆេទ / Date: {{\Carbon\Carbon::parse($row->open_date)->format('d/m/Y')}}</p>
            ...
            <td>
                ...
                <div style="border: 1px solid #000; border-radius: 5px; padding: 10px">
                    ...
                    <p>Currency:{{optional($row->currencies)->currency_name}}</p>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table style="margin-top: 20px; ">
        ...
        @foreach($row->open_item_detail as $item)
            ...
            <tr>
                ...
                <td style="font-weight: bold">{{$item->line_cost}}{{$c}}</td>
