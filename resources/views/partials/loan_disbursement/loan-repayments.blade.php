...
@section('after_scripts')
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
              $("#old_owed_total").html(crud.table.column(12).data().sum());
              $("#principle_total").html(crud.table.column(13).data().sum());
              $("#interest_total").html(crud.table.column(14).data().sum());
              $("#compulsory_saving_total").html(crud.table.column(15).data().sum());
              $("#penalty_amount_total").html(crud.table.column(16).data().sum());
              $("#other_payment_total").html(crud.table.column(17).data().sum());
              $("#total_payment_total").html(crud.table.column(18).data().sum());
              $("#owed_balance_total").html(crud.table.column(19).data().sum());
            });
    });
    ...
    $( "#excel" ).click(function() {
        ...
        var url = "{{URL::to('/admin/report/loan-repayments/excel')}}?" + $.param(query)
        window.location = url;
    });
    </script>
@endsection
