...
{{--                        <a href="#" class="btn btn-dark" type="button" id="excel"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>--}}
                ...
                <div class="overflow-hidden">
                    ...
                    <tr style="background-color:darkgray;">
                        ...
                        <td id="service_pay_total"></td>
                        <td id="saving_pay_total"></td>
                        <td id="deposit_amount_total"></td>
                    </tr>
                    <tfoot>
                        <tr>
                            @foreach ($crud->columns as $column)
       ...
       // $("#wave_total").html( $('#crudTable').column( 3 ).data().sum());
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
              ...
              $("#service_pay_total").html(crud.table.column(9).data().sum());
              $("#saving_pay_total").html(crud.table.column(10).data().sum());
              $("#deposit_amount_total").html(crud.table.column(11).data().sum());
