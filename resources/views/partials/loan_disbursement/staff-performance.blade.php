...
{{--                        <a href="#" class="btn btn-dark" type="button" id="excel"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>--}}
                ...
                <div class="overflow-hidden">
                    ...
                    <tr style="background-color:darkgray;">
                        <td>Total</td>
                        <td id="client_count_total"></td>
                        <td id="loan_outstanding_total"></td>
                        <td id="client_disburse_total"></td>
                        <td id="loan_disburse_total"></td>
...
@section('after_scripts')
    ...
    jQuery(document).ready(function($) {
        ...
        crud.table.on('draw.dt', function () {
            $("#client_count_total").html(crud.table.column(1).data().sum());
            $("#loan_outstanding_total").html(crud.table.column(2).data().sum());
            $("#client_disburse_total").html(crud.table.column(3).data().sum());
            $("#loan_disburse_total").html(crud.table.column(4).data().sum());
            $("#principle_total").html(crud.table.column(5).data().sum());
            $("#interest_total").html(crud.table.column(6).data().sum());
            $("#other_payment_total").html(crud.table.column(7).data().sum());
            $("#penalty_amount_total").html(crud.table.column(8).data().sum());
            $("#total_payment_total").html(crud.table.column(9).data().sum());
        });
    });
