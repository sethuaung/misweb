...
{{--                        <a href="#" class="btn btn-dark" type="button" id="excel"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>--}}
                ...
                <div class="overflow-hidden">
                    ...
                    <table id="crudTable" class="box table table-striped table-hover display responsive nowrap m-t-0" cellspacing="0">
                        ...
                        <td id="principle"></td>
                        <td id="interest"></td>
                        <td id="compulsory_saving"></td>
                        <td id="voluentary_saving"></td>
                        <td id="penalty"></td>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
                ...
                $("#principle").html(crud.table.column(10).data().sum());
                $("#interest").html(crud.table.column(11).data().sum());
                $("#compulsory_saving").html(crud.table.column(12).data().sum());
                $("#voluentary_saving").html(crud.table.column(13).data().sum());
                $("#penalty").html(crud.table.column(14).data().sum());
                $("#total_amount").html(crud.table.column(15).data().sum());
