                ...
                <div class="overflow-hidden">
                    ...
                    <table id="crudTable" class="box table table-striped table-hover display responsive nowrap m-t-0" cellspacing="0">
                        ...
                        <tr style="background-color:darkgray;">
                            ...
                            <td id="principle_repay"></td>
                            <td id="principle_outstanding"></td>
                            <td id="interest_repay"></td>
                            <td id="interest_outstanding"></td>
                            <td id="term_value"></td>
                            <td id="cycle"></td>
                            <td></td>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            crud.table.on('draw.dt', function () {
                ...
                $("#loan_amount").html(crud.table.column(14).data().sum());
                $("#principle_repay").html(crud.table.column(15).data().sum());
                $("#principle_outstanding").html(crud.table.column(16).data().sum());
                $("#interest_repay").html(crud.table.column(17).data().sum());
                $("#interest_outstanding").html(crud.table.column(18).data().sum());
                $("#term_value").html(crud.table.column(19).data().sum());
                $("#cycle").html(crud.table.column(20).data().sum());
                // $("#installment_amount_total").html(crud.table.column(8).data().sum());
