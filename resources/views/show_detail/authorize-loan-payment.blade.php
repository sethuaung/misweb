...
<div class="row">
    <div class="col-md-12">
        @php
            ...
            $w = \App\Models\LoanPaymentTem::find($id);
        @endphp
        @if($id > 0)
            <table  class="table table-bordered">
                ...
                <tbody>
                   <tr>
                    ...
                    <input type="hidden" value="{{$id}}" class="loan_payment_id">
                    <td style="width:40%">
                        <input class="form-control note" value="{{ optional($w)->note_check}}" type="text" style="width: 100%">
                    </td>
                    <td style="width: 20%">
