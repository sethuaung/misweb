...
@php
	$from_to = str_replace('_', '-', $filter->name);
@endphp
{{-- FILTERS EXTRA JS --}}
  ...
  <script>
		...
		jQuery(document).ready(function($) {
			...
			dateRangeInput.on('apply.daterangepicker', function(ev, picker) {
				$('#daterangepicker-{{ $from_to }}').val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
