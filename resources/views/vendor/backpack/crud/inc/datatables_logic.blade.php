  ...
  <script src="{{ asset('vendor/adminlte') }}/plugins/datatables/js/jquery.dataTables.min.js" type="text/javascript"></script>
  <script src="{{ asset('vendor/adminlte') }}/plugins/datatables/js/dataTables.bootstrap.min.js" type="text/javascript"></script>
  <script src="{{ asset('vendor/adminlte') }}/plugins/datatables/js/dataTables.responsive.min.js" ></script>
  <script src="{{ asset('vendor/adminlte') }}/plugins/datatables/js/responsive.bootstrap.min.js" ></script>
  <script src="{{ asset('vendor/adminlte') }}/plugins/datatables/js/dataTables.fixedHeader.min.js" ></script>
  ...
  <script>
    ...
    var crud = {
      ...
      lengthMenu: @if(companyReportPart()=='company.mkt'&&!in_array('com-saving-accrued-interests', $Url)) [[10, 25, 50, 100, 250, 500], [10, 25, 50, 100, 250, 500]] @else @json($crud->getPageLengthMenu())@endif,
