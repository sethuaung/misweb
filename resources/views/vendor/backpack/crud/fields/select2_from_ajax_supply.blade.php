...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        @if(isset($field['suffix'])) <div class="input-group-addon">
            <a href="" data-remote="false" data-toggle="modal" data-target="#show-create-supply"><span class="glyphicon glyphicon-plus"></span></a>
        </div> @endif
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <div class="modal fade" id="show-create-supply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-x">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">{{_t('Supply')}}</h4>
                </div>
...
<script>
    $("#show-create-supply").on("show.bs.modal", function(e) {
        var link = '{{url('admin/supply/create?is_frame=1')}}';
