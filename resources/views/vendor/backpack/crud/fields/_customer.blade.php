        ...
        @if (isset($field['model']))
            @foreach ($field['model']::all() as $connected_entity_entry)
                    ...
                    @if($current_value == $connected_entity_entry->getKey())
                        <option value="{{ $connected_entity_entry->getKey() }}"  data-currency_id="{{$connected_entity_entry->{$field['currency_id']} }}" selected>{{ $connected_entity_entry->{$field['attribute']} }}</option>
                    @else
                        <option value="{{ $connected_entity_entry->getKey() }}"  data-currency_id="{{$connected_entity_entry->{$field['currency_id']} }}">{{ $connected_entity_entry->{$field['attribute']} }}</option>
                    @endif
