...
class LoanApi extends Model
{
    ...
    */
    ...
    protected $fillable = ['branch_id', 'center_leader_id', 'center_code_id',
        ...
        'disbursement_number', 'group_loan_id', 'disbursement_name', 'deposit_paid', 'you_are_a_group_leader', 'you_are_a_center_leader', 'plan_disbursement_date'];
...
data-remote="false" data-toggle="modal" data-target="#show-detail-modal" class="btn btn-xs btn-info"><i class="fa fa-print"></i></a>';
    ...
    public static function boot()
    {
        ...
        static::creating(function ($obj) {
            ...
            GroupLoanDetailM::where('loan_id', $obj->id)->delete();
            if ($group_loan_id != null) {
                if ($group_loan_id > 0 && $client_id > 0) {

                    $m = new GroupLoanDetailM();
