...
class CapitalWithdraw extends Model
{
    ...
    */
    ...
    protected $table = 'capital_withdraws';
    ...
    */
    ...
    public static function accWithdrawCapitalTransaction($row)
    {
        if ($row != null) {
            $acc = GeneralJournal::where('tran_id', $row->id)->where('tran_type', 'capital-withdraw')->first();
            if ($acc == null) {
            ...
            $acc->tran_id = $row->id;
            $acc->tran_type = 'capital-withdraw';
            ...
            if ($acc->save()) {
                ...
                $c_acc->tran_type = 'capital-withdraw';
                //$c_acc->num = '';
                //$c_acc->name = '';
    ...
    */
    public static function boot()
    {
        ...
        static::deleting(function ($row) {
            GeneralJournal::where('tran_id', $row->id)->where('tran_type', 'capital-withdraw')->delete();
            GeneralJournalDetail::where('tran_id', $row->id)->where('tran_type', 'capital-withdraw')->delete();
        });
    }
    /*
    |--------------------------------------------------------------------------
