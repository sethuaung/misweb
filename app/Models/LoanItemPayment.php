...
class LoanItemPayment extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $fillable = ['payment_number', 'client_id', 'disbursement_id', 'receipt_no', 'over_days', 'penalty_amount', 'principle', 'interest', 'old_owed', 'other_payment', 'total_payment', 'payment', 'payment_date', 'owed_balance', 'payment_method', 'cash_acc_id',
        'document', 'note', 'disbursement_detail_id', 'principle_balance', 'compulsory_saving', 'principle_pd', 'penalty_pd', 'service_pd', 'compulsory_pd', 'pre_repayment', 'old_interest', 'excel', 'payment_pending_id'
    ];
    // protected $hidden = [];
