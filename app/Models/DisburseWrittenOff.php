...
class DisburseWrittenOff extends Loan
{
    use CrudTrait;
    ...
    */
    ...
    //protected $fillable = ['loan_id','branch_id','loan_number','loan_write_off_amt','write_off_date','reason'];
    // protected $hidden = [];
    ...
    */
    ...
    public static function boot()
    {
        ...
        static::addGlobalScope('disbursement_status', function (Builder $builder) {
            $builder->where('disbursement_status', 'Written-Off');
        });
    }
    /*
    |--------------------------------------------------------------------------
