 ...
 */
class LoanDisburesementDepositUCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/loandisburesementdepositu');
        $this->crud->setEntityNameStrings('Deposit', 'All Deposits');
...
//        }
    ...
    public function store(StoreRequest $request)
    {
        ...
        if($loan_disbursement->deposit_paid == 'Yes'){
            return redirect('admin/loandisburesementdepositu/create')->withErrors('Already Exist'); 
        }else{
