 ...
 */
class LoanPendingApprovalCrudController extends CrudController
{
...
//        dd($m_);
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\DisbursePendingApproval');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/disbursependingapproval');
        $this->crud->setEntityNameStrings('Disburse Pending Approval', 'Disburse Pending Approval');
