 ...
 */
class CapitalWithdrawCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\CapitalWithdraw');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/capital-withdraw');
        $this->crud->setEntityNameStrings('Withdraw Capital', 'Withdraw Capitals');
...
//        }
    ...
    public function store(StoreRequest $request)
    {
        ...
        CapitalWithdraw::accWithdrawCapitalTransaction($this->crud->entry);
