 ...
 */
class DropOutMemberClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/drop_out-member-client');
        $this->crud->setEntityNameStrings('Drop-out Member', 'Drop-out Members');
        ...
        */
        ...
        $this->crud->addClause('where','customer_group_id','=',3);
