 ...
 */
class ListDisbursementLoanItemCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\ListDisburseLoanItem');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/list-disbursement-loan-item');
        $this->crud->setEntityNameStrings('Loan Disbursement', 'Loan Disbursements');
