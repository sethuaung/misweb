 ...
 */
class LoanWrittenOffCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\DisburseWrittenOff');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/disbursewrittenoff');
