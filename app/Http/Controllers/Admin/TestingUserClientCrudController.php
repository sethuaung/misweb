 ...
 */
class TestingUserClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/testing-user-client');
        ...
        */
        ...
        $this->crud->addClause('where','customer_group_id','=',6);
