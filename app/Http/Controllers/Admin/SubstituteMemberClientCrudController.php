 ...
 */
class SubstituteMemberClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/substitute-member-client');
        $this->crud->setEntityNameStrings('Substitute Member', 'Substitute Members');
        ...
        */
        ...
        $this->crud->addClause('whereIn','customer_group_id',[5,8,9]);
