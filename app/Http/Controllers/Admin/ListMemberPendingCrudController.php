 ...
 */
class ListMemberPendingCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/list-member-pending');
    ...
    public function index()
    {
        ...
        return view('partials.group-loan.customer-list');
    }
