 ...
 */
class RejoinMemberClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/rejoin-member-client');
        $this->crud->setEntityNameStrings('Rejoin Member', 'Rejoin Members');
        ...
        */
        ...
        $this->crud->addClause('whereIn','customer_group_id',[3,4]);
