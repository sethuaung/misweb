 ...
 */
class ListMemberRepaymentCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings('list-member-repayment', 'list_member_repayments');
    ...
    public function index()
    {
        ...
        $loan =  \App\Models\Loan::where('group_loan_id',$group_loan_id)
            ...
            ->get();*/
        /*$loan = Loan::join('loan_disbursement_calculate',getLoanCalculateTable().'.disbursement_id',getLoanTable().'.id')
        ...
        return view('partials.group-repayment.customer-repayment',['loan_detail'=>$loan_detail,'gg'=>$gg,'jj'=>$jj,'date_s'=>$date_s]);
    }
