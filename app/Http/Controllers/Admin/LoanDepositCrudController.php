 ...
 */
class LoanDepositCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\LoanDeposit');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/loandisbursementdeposit');
