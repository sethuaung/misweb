 ...
 */
class RejectClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/reject-client');
        $this->crud->setEntityNameStrings('Reject Client', 'Reject Clients');
        ...
        */
        ...
        $this->crud->addClause('where','customer_group_id','=',11);
