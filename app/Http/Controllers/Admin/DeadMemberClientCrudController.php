 ...
 */
class DeadMemberClientCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/dead-member-client');
        $this->crud->setEntityNameStrings('Dead Member', 'Dead Members');
        ...
        */
        ...
        $this->crud->addClause('where','customer_group_id','=',2);
