...
use App\Models\DisburseLoanItem;
...
use App\Http\Requests\DisbursementLoanItemRequest as StoreRequest;
use App\Http\Requests\DisbursementLoanItemRequest as UpdateRequest;
 ...
 */
class DisburseLoanItemCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\DisburseLoanItem');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/loan-item-disbursement');
        ...
        */
        ...
        $product_name = '';
        if ($loan_id > 0) {
            $m = LoanItem::find($loan_id);
            $client_name = optional($m)->client_name->name;
            $nrc = optional($m)->client_name->nrc_number;
            $product_name = optional($m)->items->product_name;
        }
        //$m = null;
        //$m = optional(Loan::all());
        ...
        $this->crud->addColumn([
            ...
            'model' => "App\\Models\\DisburseLoanItem", // foreign key model
        ]);
        ...
        */
        ...
        $this->crud->addField([
            ...
            'type' => 'view',
            'view' => 'partials/loan_disbursement/disbursement-item',
        ...
        $this->crud->addField([
            ...
            'default' => 0,
            'wrapperAttributes' => [
                'class' => 'form-group col-md-4 deposit'
            ],
        ...
        $this->crud->addField([
            'name' => 'product_id',
            'type' => 'hidden',
            'default' => $m == null ? 0 : $m->product_id,
            'value' => $m == null ? 0 : $m->product_id,
...
//        }
        ...
        DisburseLoanItem::accDisburseLoanItem($this->crud->entry);
        ...
        $principal_amount = $deburse->total_money_disburse;
